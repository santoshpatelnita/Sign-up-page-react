...
function App() {
  return (
    <form class="container.md my-6 xl:mx-16 sm:mx-2 md:mx-6  bg-while-900 rounded px-5 pt-8 grid gap-4 items-center">
...
<center>
      <button class=" bg-gray-800 hover:bg-gray-900  text-white font-bold py-2 px-4 rounded-full xl:w-1/6 sm:w-1/2 "  type="button" >Sign up</button>
</center>
